...
if(isset($_POST['place_order']))
{
  ...
  //$_SESSION ['cart']; // [4=>[]] keyy is the product id and the value is an info about the product
  ...
  //5.remove everything from cart ----> after payment is done
  //unset($_SESSION['cart']) ;



  //6 .inform user whether everything is fine of there is a problem
